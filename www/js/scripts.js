...
function loadMapa(){
	if(MAP != null){
		...
		if(LAT != 0){
			...
			var tilelayer = L.tileLayer(target+'localTiles/{z}/{x}/{y}@2x.png', {
				minZoom: 17
				,maxZoom: 18
				,errorTileUrl : 'http://api.tiles.mapbox.com/v4/mapbox.light/'
				,attribution: mbAttr
				,detectRetina: true
				,zIndex: 1
			}).addTo(MAP);
