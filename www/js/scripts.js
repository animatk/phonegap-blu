...
function show_map(back){
	...
	var data = {
		labels: ["10m", "30m", "50m", "1.1h", "1.5h", "1.8h", "2h"],
		datasets: [{
				label: "My Second dataset",
				fillColor: "rgba(99, 224, 90, 0)",
				strokeColor: "rgba(99, 224, 90, 0.5)",
				pointColor: "rgba(99, 224, 90, 0.9)",
				pointStrokeColor: "#fff",
				pointHighlightFill: "#fff",
				pointHighlightStroke: "rgba(151,187,205,1)",
				data: [110, 125, 150, 130, 155, 140, 130]
			}]
	};
