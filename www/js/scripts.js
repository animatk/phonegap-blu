...
L.Map.TouchExtend = L.Handler.extend({
  ...
  //  var containerPoint = this._map.mouseEventToContainerPoint(e);
	...
	var top = e.touches[0].clientY - $('#map-canvas').offset().top;
	var point = new L.Point(left, top);
    var  layerPoint = this._map.containerPointToLayerPoint(point);
